...
import staffcard from "../../../assets/logo/AMMAP MILMI.png";
import motoicon from "../../../assets/image/moto.png";
function DeliveryCard({name,block,id,image}) {
  return (
    <>
      ...
      <div className="w-[9cm] bg-white h-[6cm] relative">
        <div className="card-outline absolute w-full h-full p-[2px] flex justify-center items-center">
          <div className="main-card w-[100%] h-[100%] rounded-[14px] border-[#02085b] border-[3px]">
            ...
            <div className="permission text-[#fa5d5d] text-2xl font-bold ransform scale-x-71 scale-y-100 absolute top-[1.25cm] left-[1.74cm] w-full">
              ...
              <div className="line w-[77%] h-[4px] rounded-full bg-[#021af8]"></div>
            </div>
            ...
            <div className="container-card-inforw-full flex gap-3 text-black font-bold">
              ...
              <div class="infor pt-5">
                ...
                <p class="leading-tight">Position : Delivery</p>
            ...
            <div className="moto-icon absolute w-[2.2cm] top-[2.4cm] left-[6.6cm] opacity-60">
