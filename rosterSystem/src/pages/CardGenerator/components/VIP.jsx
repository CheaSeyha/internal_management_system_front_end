...
function VIP({ name, block, id, platNumber, image, cardType }) {
  return (
    <>
      {/* Delivery Card */}
      {cardType === "Delivery" && (
        <main className="deliverycard relative font-cardFont2 w-[9cm] h-[6cm] text-black bg-white">
          ...
          <p className="forName absolute text-[18px] top-[2.16cm] left-[5.14cm]">
            {name}
          </p>
      ...
      {cardType === "Staff" && (
        <main className="relative font-cardFont2 w-[9cm] h-[6cm] text-black bg-white">
          ...
          <p className="forName absolute text-[18px] top-[2.16cm] left-[5.21cm]">
            {name}
          </p>
          <p className="staffcard forBlock absolute text-[18px] top-[3.26cm] left-[5.21cm]">
            {block}
          </p>
          <p className="forID absolute text-[18px] top-[3.84cm] left-[5.21cm]">
            {id}
          </p>
          <div className="image-tamplete w-full h-full">
      ...
      {cardType === "VIP Card" && (
        <main className="vipcard relative font-cardFont2 w-[9cm] h-[6cm] text-black bg-white">
          <p className="forName absolute text-[18px] top-[2.16cm] left-[5.25cm]">
            {name}
          </p>
          <p className="staffcard forBlock absolute text-[18px] top-[3.26cm] left-[5.25cm]">
            {block}
          </p>
          <p className="forID absolute text-[18px] top-[3.84cm] left-[5.25cm]">
            {id}
          </p>
          <div className="image-tamplete w-full h-full">
            <img src={vipcard} alt="" />
      ...
      {cardType === "Car Card" && (
        <main className="carcard relative font-cardFont1 w-[20cm] h-[13.34cm] text-black bg-white">
          <p className="plat-number absolute text-[2.9cm] text-[#0d07fd] top-[6.57cm] left-[4.79cm] text-stroke">
            {platNumber}
          </p>
          <div className="image-tamplete w-full h-full">
